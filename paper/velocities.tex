...
may not impact our final vertical velocity dispersion measurements
significantly (and this is the real quantity we care about).
...
brightness.
Since \vz\ is the only velocity we will actually use to infer kinematic ages,
this indicates that the choice of prior not strongly impact our final results.
...
distributions would look very different.
